...
$sql = "SELECT * FROM tb_subscription ORDER BY date DESC";
...
?>
											<tr class="odd gradeX">
												...
												<td class="center"><?php echo$row["f_name"] ?> <?php echo$row["l_name"] ?></td>
												...
												<td class="center"><?php echo$row["course_price"] ?></td>
												<td>
