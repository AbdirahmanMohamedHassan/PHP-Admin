                    ...
                    <div class="row">
                           <div class="card-box">
                               <div class="card-head">
								   ...
								   <a href="add_course.php?certificate=<?php echo $_GET['certificate']; ?>"><button style="float:right" type="button" href="edit_certificate.php" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-success">Add Course</button></a>
...
$sql = "SELECT * FROM tb_course,tb_professor where tb_course.course_professor = tb_professor.professor_id and tb_course.certificate_code='$_GET[certificate]'";
								...
								<div class="col-lg-6 col-md-6 col-12 col-sm-6"> 
									<div class="blogThumb">
			                        	...
			                        	<h4><?php echo$row["course_name"] ?></h4>
				                           ...
				                           <a href="edit_course.php?course_code=<?php echo$row["course_code"] ?>&certificate=<?php echo$_GET["certificate"] ?>"> <button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-info">Edit Course</button></a>
