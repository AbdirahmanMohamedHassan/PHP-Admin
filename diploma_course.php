                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Diploma Courses List</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="index.php">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>
                                <li><a class="parent-item" href="#">Diploma</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>
                                <li class="active">Diploma Courses List</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                           <div class="card-box">
                               <div class="card-head">
                                   <header>Diploma Courses List</header>
								   <a href="add_diploma_course.php?diploma=<?php echo $_GET['diploma']; ?>"><button style="float:right" type="button" href="edit_certificate.php" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-success">Add Diploma Course</button></a>
...
$sql = "SELECT * FROM tb_diplomacourse,tb_professor where tb_diplomacourse.course_professor = tb_professor.professor_id and tb_diplomacourse.diploma_code='$_GET[diploma]'";
								...
								<div class="col-lg-6 col-md-6 col-12 col-sm-6"> 
									<div class="blogThumb">
			                        	...
			                        	<h4><?php echo$row["course_name"] ?></h4>
				                           ...
				                           <a href="edit_diploma_course.php?course_code=<?php echo$row["course_code"] ?>&diploma=<?php echo$_GET["diploma"] ?>"> <button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-info">Edit Course</button></a>
...
echo "<center><h2>no Diploma Courses avaliabe</h2></center>";}?>
