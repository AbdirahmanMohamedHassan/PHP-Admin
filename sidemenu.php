	                ...
	                <div id="remove-scroll">
	                    <ul class="sidemenu  page-header-fixed" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
	                        ...
	                        <li class="nav-item start ">
							 ...
							 <li class="nav-item start ">
	                            <a href="all_certificates.php" class="nav-link nav-toggle">
							...
							<li class="nav-item start ">
	                            <a href="all_diplomas.php" class="nav-link nav-toggle">
	                                <i class="material-icons">school</i>
							 ...
							 <li class="nav-item start ">
	                            <a href="short_courses.php" class="nav-link nav-toggle">
	                                <i class="material-icons">school</i>
	                                <span class="title">Short Courses</span>
	                            </a>
	                        
	                        </li>
							<li class="nav-item">
	                            <a href="payments.php" class="nav-link nav-toggle"> <i class="material-icons">monetization_on</i>
	                                <span class="title">Fees</span> </span>
	                            </a>
	                        </li>
	                        <li class="nav-item">
	                            <a href="all_professors.php" class="nav-link nav-toggle"> <i class="material-icons">person</i>
	                       ...
	                       <li class="nav-item start ">
	                        ...
	                        <li class="nav-item">
	                            ...
	                            <ul class="sub-menu">
	                                <li class="nav-item">
	                                    <a href="students.php" class="nav-link "> <span class="title">All Students</span>
	                                    </a>
	                                </li>
