...
$result = $mysqli->query("SELECT * FROM tb_diplomacourse WHERE course_code='$_GET[course_code]' AND diploma_code='$_GET[diploma]'");
...
$sql = "SELECT * FROM tb_diplomacourse,tb_professor where tb_diplomacourse.course_professor = tb_professor.professor_id and tb_diplomacourse.course_code='$_GET[course_code]'";
...
?>
				...
				function pro() {
					include ("db.php");
    $sql = "SELECT * FROM tb_diplomacourse,tb_professor where tb_diplomacourse.course_code='$_GET[course_code]'";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
	while($row = $result->fetch_assoc()) {
		?>
...
if(isset($_POST['submit'])){
	...
	if( empty($_POST['course_name']) || empty($_POST['course_description']) || empty($_POST['course_professor']) || empty($_POST['course_duration'])
        ...
        <strong>Woah!</strong> Fill out all the information please.
		 ...
		 header("location:edit_diploma_course.php?course_code=$_GET[course_code]&certificate=$_GET[diploma]");
	}else{
...
// active is 0 by DEFAULT (no need to include it here)
    ...
    $sql="UPDATE tb_diplomacourse SET course_name='$course_name' , course_description='$course_description' , course_professor='$course_professor'
