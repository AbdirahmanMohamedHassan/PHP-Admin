...
?>  
                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="blog_title" placeholder="enter blog title" class="form-control input-height" /> </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <textarea id="summernote" style="tabsize:2;height:100" name="blog_content" placeholder="course details" class="form-control-textarea" rows="5" ></textarea>
                                                </div>
                                            </div>
...
// active is 0 by DEFAULT (no need to include it here)
    $sql = "INSERT INTO tb_blog (blog_title,blog_content,blog_image,blog_date) " 
            . "VALUES ('$blog_title','$blog_content','$filepath','$date')";
echo $sql;
