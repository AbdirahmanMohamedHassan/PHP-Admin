...
?>
                                   <form action="" method=POST id="form_sample_1" class="form-horizontal" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="professor_name" data-required="1" placeholder="enter first name" class="form-control input-height" /> </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="professor_last" data-required="1" placeholder="enter last name" class="form-control input-height" /> </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control input-height" name="professor_email" placeholder="Email Address"> </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input name="professor_number" type="text" placeholder="mobile number" class="form-control input-height" /> </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="professor_location" data-required="1" placeholder="enter location" class="form-control input-height" /> </div>
                                            </div>
											<div class="form-group row">
												<label class="control-label col-md-3">Background of Professor 
												</label>
												<div class="col-md-5">
													<textarea id="summernote" style="tabsize:2;height:100" name="professor_background" class="form-control-textarea" placeholder="Education" rows="5"></textarea>
												</div>
											</div>
											 <div class="form-group row">
...
// active is 0 by DEFAULT (no need to include it here)
    $sql = "INSERT INTO tb_professor (professor_name,professor_last,professor_email,professor_gender,professor_number,professor_location,professor_background,professor_image,date) " 
            . "VALUES ('$professor_name','$professor_last','$professor_email','$professor_gender','$professor_number','$professor_location','$professor_background','$filepath','$date')";
echo $sql;
    // Add user to the database
    if ( $mysqli->query($sql) ){
		$_SESSION['adminmessage']= " <div class='alert alert-success'>
        <strong>Well done!</strong> You successfully added a new professor.
                    </div>";
		 header("location:all_professors.php");
	}
else {
   $_SESSION['adminmessage']= " <div class='alert alert-danger'>
        <strong>Warning!</strong> You weren't successful in adding a new professor.
                    </div>";
header("location:all_professors.php");
    }
}}
