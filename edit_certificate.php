...
$result = $mysqli->query("SELECT * FROM tb_certificates WHERE certificate_code='$_GET[certificate]'");
...
$sql = "SELECT certificate_name,certificate_code,image,date,certificate_description FROM tb_certificates where certificate_code='$_GET[certificate]'";
...
?>
                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="certificate_name" value="<?php echo$row["certificate_name"] ?>" class="form-control input-height" required/> </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="certificate_code" value="<?php echo$row["certificate_code"] ?>" class="form-control input-height" disabled> </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <textarea name="certificate_description" class="form-control-textarea" rows="5" ><?php echo$row["certificate_description"] ?></textarea>
                                                </div>
...
if(isset($_POST['submit'])){
	...
	if( empty($_POST['certificate_name']) || empty($_POST['certificate_description'])) {
		$_SESSION['adminmessage']= " <div class='alert alert-danger'>
...
// active is 0 by DEFAULT (no need to include it here)
			...
			$sql="UPDATE tb_certificates SET certificate_name='$certificate_name', certificate_description='$certificate_description', image='$filepath' WHERE certificate_code= '$_GET[certificate]'";
echo $sql;
