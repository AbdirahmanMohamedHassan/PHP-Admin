...
if(isset($_POST['submit'])){
	...
	if( empty($_POST['course_name']) || empty($_POST['course_code']) || empty($_POST['course_description']) || empty($_POST['course_professor']) || empty($_POST['course_duration'])
        ...
        <strong>Woah!</strong> Fill out all the information please.
		 ...
		 header("location:add_short_course.php");
	}else{
...
// active is 0 by DEFAULT (no need to include it here)
    $sql = "INSERT INTO tb_shortcourse (course_name,course_code,course_description,course_professor,course_duration,course_price,course_level,course_image,course_date) " 
            . "VALUES ('$course_name','$course_code','$course_description','$course_professor','$course_duration','$course_price','$course_level','$filepath','$date')";
echo $sql;
